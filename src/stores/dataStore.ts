...
export const useDataStore = create<DataState>()((set, get) => {
  ...
  const refresh = async (...keys: ('cars' | 'drivers' | 'shifts' | 'payments' | 'maintenances' | 'expenses')[]) => {
  ...
  return {
    ...
    loadAll: async () => {
      ...
      try {
        ...
        const [cars, drivers, shifts, payments, maintenances, expenseTypes, expenses] = await Promise.all([
          ds.cars.list(),
          ds.drivers.list(),
          ds.shifts.list(),
          ds.payments.list(),
