import { Car, CircleCheck, HandCoins, Home, LogOut, Moon, Sun, SunMoon, TrendingDown, TrendingUp, Wrench } from 'lucide-react';
...
const SECTIONS = [
  ...
  { title: 'Gastos Saldados', url: '/settled-expenses', icon: CircleCheck },
